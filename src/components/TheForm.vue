<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: userMameValidity==='invalid'}" >
      <label for="user-mail">Email</label>
      <input id="user-mail" name="user-email" type="email" v-model.trim="userMail" @blur="validateInput"/>
      <P v-if="userEmailValidity === 'invalid'">please enter a valid data </P>
    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="userAge"  />
    </div>
    <div class="form-control">referrer
...
export default{
  ...
  methods:{
    ...
    validateMail(){
      if(this.userMail===''){
        this.userMailValidity ='invalid';
      }else{
        this.userMailValidity='valid'
      }
    },
  }
};
